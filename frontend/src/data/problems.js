...
print(maxArea([1,1]))  # Expected: 1`,
  ...
  description: {
    ...
    notes: [
      ...
      "You must not merge arrays fully in optimal solution."
    ],
  },
  examples: [
    {
    ...
    },
    {
      ...
      output: "2.5",
      explanation: "Merged array = [1,2,3,4], median = (2+3)/2.",
    },
  ],
  constraints: [
    "nums1.length == m",
  ...
  examples: [
    {
      ...
      output: "6",
      explanation: "Water trapped is 6 units.",
    },
    {
